...
var principal = require("./routes/principal.js");
var jogoDaVelha = require("./routes/jogoDaVelha.js");
var abcash = require("./routes/abcash.js");
var sobre = require("./routes/sobre.js");
var projetos = require("./routes/projetos.js");

app.use('/client',express.static(__dirname + "/client"));
app.use("/", principal);
app.use("/jogo-da-velha", jogoDaVelha);
app.use("/abcash", abcash);
app.use("/sobre", sobre);
